...
with open(f'{DIR_RESOURCES}credentials.json') as credentials_file:
...
<<<<<<< HEAD
FAILD_TOLERATE_NEW_POST = 2
FAILD_TOLERATE_RELATED_QUESTION = 5
=======
FAILD_TOLERATE_NEW_POST = 200
FAILD_TOLERATE_RELATED_QUESTION = 10
>>>>>>> master
